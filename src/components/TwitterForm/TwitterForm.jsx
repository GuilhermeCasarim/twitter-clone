...
export const TwitterForm = ({ onTweet }) => {
    ...
    return (
        <div className="border-b border-gray-800 p-4">
            <textarea className="w-full bg-transparent text-white text-xl resize-none outline-none" placeholder="What's happening?" ref={textAreaRef}>
            </textarea>
            <div className="flex justify-between items-center mt-4">
                ...
                <button className="bg-blue-400 text-white font-bold px-4 py-2 rounded-full hover:bg-blue-600 transition duration-300" onClick={handleSubmit}>Tweet</button>
            </div>
        </div>
    )
}
